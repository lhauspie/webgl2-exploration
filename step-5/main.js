...
function initBuffers(gl) {
  ...
  colorBuffer.numItems=colorVertices.length / colorBuffer.itemSize;
...
function drawScene(gl, programInfo, buffers, rotation) {
  ...
  mat4.translate(modelViewMatrix,     // destination matrix
                 ...
                 [0.5, 0.5, -5.5]);  // amount to translate
  ...
  draw_buffer(gl, buffers.color, programInfo.attribLocations.vertexColor, false);
  draw_buffer(gl, buffers.squarePosition, programInfo.attribLocations.vertexPosition, true);
  draw_buffer(gl, buffers.trianglePosition, programInfo.attribLocations.vertexPosition, true);
}

function draw_buffer(gl, buffer, attribLocation, drawArrays) {
